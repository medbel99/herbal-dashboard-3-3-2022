...
const ShopItems_copy = ({ columns = 4, pageSize = 12,categoryId }) => {
    ...
    useEffect(() => {
        ...
        getTotalRecords();
        getProductsByCollection(categoryId);
        handleSetColumns();
    }, [query]);
    ...
    return (
        <div className="ps-shopping">
            <div className="ps-shopping__header">
                <p>
                    <strong className="mr-2">{productItemsView.length}</strong>
                    Products found
                </p>
